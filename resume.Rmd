---
title: Amy Resume" Trumpower's
author: Amy Teresa mpower
date: "`r Sys.Date()`"
output:
...
position_data <- read_csv('positions.csv') %>% 
  ...
  mutate(
    ...
    section = case_when(
      section %in% c('certification', 'industry_positions') ~ 'positions', 
      section %in% c('data_science_writings', 'by_me_press') ~ 'education',
      TRUE ~ section
    )
  ) 
...
- <i class="fa fa-phone"></i> (555) 645-7577
